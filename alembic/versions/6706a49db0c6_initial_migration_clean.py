...
Revision ID: 6706a49db0c6
Revises: 
Create Date: 2025-09-19 00:27:06.944381
...
def upgrade() -> None:
    ...
    sa.Column('auto_interview_enabled', sa.Boolean(), nullable=True),
    sa.Column('auto_interview_threshold', sa.Integer(), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('hidden_for_hr', sa.Boolean(), nullable=True),
    ...
    sa.Column('brief_reason', sa.Text(), nullable=True),
